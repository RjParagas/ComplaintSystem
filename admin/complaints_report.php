            ...
            <div class="col-md-12">
                <table class="table table-bordered" id='report-list'>
                    ...
                    <tbody>
			          <?php
                      $i = 1;
                      $qry = $conn->query("SELECT tblcomplaints.*,users.fullName as name,category.categoryName as catname from tblcomplaints join users on users.id=tblcomplaints.userId join category on category.id=tblcomplaints.category where tblcomplaints.complaintNumber=''");
                      if($qry->num_rows > 1):
			          ...
			          <tr class=""> 
			            ...
			            <td>
                            <p><small>Report: <?php echo $row['complaintDetails'] ?></small></p>
                            <p><small>Address: <?php echo $row['regDate'] ?></small></p>
                        </td>
