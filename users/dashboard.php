...
{?>
					  			...
					  			<p><?php echo htmlentities($num1);?> Unprocessed Complaints</p>
                  		</div>
                      <?php }?>
...
{?>
                  ...
                  <p><?php echo htmlentities($num1);?> Complaints being Processed</p>
                      </div>
  <?php }?>
...
{?>
                  ...
                  <p><?php echo htmlentities($num1);?> Processed Complaints</p>
                      </div>
